...
DQX.Gui.ChromoPlot = function (iid, args) {
    ...
    that.leftsize = 90; //size of the fixed scale
    ...
    {//Create body
        ...
        cnvcenter.setWidthPx(width - 1 - that.leftsize).setHeightPx(that.bodyHeight);
        cnvcenter.addAttribute("width", width - 1 - that.leftsize).addAttribute("height", that.bodyHeight);
        html += body;
    }
    ...
    {//Create footer
        ...
        footer.addElem('Find feature:&nbsp;&nbsp;');
        footer.setCssClass('DQXDarkFrameHighlight');
