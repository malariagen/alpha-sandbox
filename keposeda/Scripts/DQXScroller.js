...
DQX.HScrollBar = function(iCanvasID) {
    var that = DQX.myCanvasElement(iCanvasID)
    that.sizeX = that.myCanvasElement.width;
    that.sizeY = that.myCanvasElement.height;
    ...
    that.registerHandlers(that.myCanvasElement);
    ...
    that.resize = function (newsizex) {
        this.sizeX = newsizex;
        $(this.myCanvasElement).width(newsizex);
        this.myCanvasElement.width = newsizex;
        this.draw();
    }
    ...
    that.draw = function () {
        ...
        var centercontext = this.myCanvasElement.getContext("2d");
    ...
    that._onMouseHover = function (ev) {
        ...
        $('#' + this.myCanvasID).css('cursor', sizemouse ? 'w-resize' : 'auto');
    }
